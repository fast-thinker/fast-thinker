...
class ThinkerConfig:
    ...
    n_problems_per_epoch: int = field(default_factory=lambda: _env_int("THINKER_N_PROBLEMS_PER_EPOCH", 30))
    n_long_context_qa_per_epoch: int = field(default_factory=lambda: _env_int("THINKER_N_LONG_CONTEXT_QA_PER_EPOCH", 20))
